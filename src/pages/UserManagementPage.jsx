...
export default function UserManagementPage() {
  ...
  return <main className="dashboard-content admin-page user-management-page">
    ...
    <section className="admin-panel">
      <div className="admin-toolbar"><div><h2>Local user accounts</h2><p>Accounts with access to the document portal.</p></div><input name="userSearch" aria-label="Search users" value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search users..." /></div>
